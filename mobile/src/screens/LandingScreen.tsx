...
const NAV_ITEMS = ['Home', 'Resources', 'Safety Plan', 'Journal', 'Support'];
...
const AUDIENCE_CHIPS = ['Teens', 'Young Adults', 'Adults', 'Seniors', 'LGBTQ+', 'All Ethnicities'];
  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        >
          <LinearGradient
            colors={['rgba(3, 6, 20, 0.68)', 'rgba(10, 5, 36, 0.18)', 'rgba(4, 7, 21, 0.92)']}
            locations={[0, 0.5, 1]}
          ...
          <Image
            source={teenGroup}
            resizeMode="contain"
            style={[styles.heroPeople, isWide ? styles.heroPeopleWide : styles.heroPeopleNarrow]}
          />
            ...
            <View style={[styles.header, !isWide && styles.headerCompact]}>
              ...
              {isWide && (
                <View style={styles.topNav}>
                  {NAV_ITEMS.map((item) => (
                    <TouchableOpacity key={item} activeOpacity={0.78} onPress={goToSignUp} style={styles.topNavItem}>
              ...
              {isWide && (
                <>
                  ...
                  <View style={styles.quotePill}>
                    <Text style={styles.quoteText}>"You are brave. You are strong. You matter."</Text>
        ...
        <View style={[styles.pageContent, { maxWidth: isDesktop ? 1520 : 980 }]}>
                ...
                >
                  ...
                  <View style={styles.featureContent}>
                    <View
                      style={[
                        styles.featureIcon,
                        { borderColor: `${card.iconColor}88`, backgroundColor: `${card.iconColor}26` },
                      ]}
                    >
                      <Text style={[styles.featureIconText, { color: card.iconColor }]}>{card.icon}</Text>
                    </View>
          ...
          <View style={[styles.panelGrid, !isWide && styles.stackedGrid]}>
            ...
            >
              ...
              {['No one will know unless you tell them.', 'Hide the app. Lock the app.', 'Your safety is our priority.'].map(
                (line) => (
            ...
            >
              <View style={styles.hiddenCopy}>
                ...
                {['Tap the shield icon', 'Long press the logo', 'Tap the logo 3 times'].map((line) => (
...
const styles = StyleSheet.create({
  root: { backgroundColor: '#050715', flex: 1 },
  ...
  headerCompact: { paddingHorizontal: 18 },
  ...
  topNavText: { color: '#d8cdef', fontSize: 16, fontWeight: '500' },
  headerActions: { alignItems: 'center', flexDirection: 'row', gap: 12 },
  signInPill: {
    alignItems: 'center',
    borderColor: 'rgba(217, 188, 255, 0.5)',
    borderRadius: 18,
    borderWidth: 1,
    justifyContent: 'center',
    minHeight: 44,
  ...
  signInText: { color: '#e7c9ff', fontSize: 14, fontWeight: '800' },
  createPill: {
    alignItems: 'center',
  ...
  heroPeople: { opacity: 0.96, position: 'absolute', zIndex: 1 },
  heroPeopleWide: { bottom: -38, height: '86%', right: 22, width: '76%' },
  heroPeopleNarrow: { bottom: 10, height: 350, right: -160, width: 620 },
  heroBody: { flex: 1, justifyContent: 'center', paddingHorizontal: 72, paddingTop: 10, zIndex: 2 },
  heroBodyCompact: { justifyContent: 'flex-start', paddingHorizontal: 24, paddingTop: 54 },
  heroCopy: { maxWidth: 430 },
  heroCopyCompact: { maxWidth: 360 },
  heroTitle: {
    color: '#d9c3ff',
    fontSize: 64,
    fontWeight: '900',
  ...
  heroTitleCompact: { fontSize: 48, lineHeight: 52 },
  heroSubtitle: { color: '#efe8ff', fontSize: 16, lineHeight: 22, marginBottom: 20, maxWidth: 330 },
  helpButton: {
    alignItems: 'center',
    backgroundColor: '#9a4fff',
    borderRadius: 26,
  ...
  learnText: { color: '#e6d7ff', fontSize: 15, fontWeight: '700' },
  learnArrow: { color: '#f0ddff', fontSize: 16, fontWeight: '700' },
  heroNote: {
    color: '#e6c9ff',
    fontSize: 20,
    fontStyle: 'italic',
  ...
  featureShell: { minWidth: 0 },
  featureShellWide: { flex: 1 },
  fullWidth: { width: '100%' },
  featureCard: {
  ...
  featureContent: { height: '100%', justifyContent: 'center', maxWidth: 250, paddingHorizontal: 22, paddingVertical: 18 },
  featureIcon: {
    alignItems: 'center',
    borderRadius: 25,
    borderWidth: 1,
  ...
  featureIconText: { fontSize: 22, fontWeight: '900' },
  featureTitle: { color: '#f8f4ff', fontSize: 20, fontWeight: '800', marginBottom: 12 },
  featureDescription: { color: '#ece8f8', fontSize: 14, lineHeight: 20, marginBottom: 20 },
  openPill: {
    alignItems: 'center',
  ...
  openText: { color: '#f5efff', fontSize: 14, fontWeight: '700' },
  openArrow: { color: '#f5efff', fontSize: 14, fontWeight: '700' },
  panelGrid: { flexDirection: 'row', gap: 14 },
  panel: { borderColor: 'rgba(149, 110, 255, 0.28)', borderRadius: 12, borderWidth: 1, minHeight: 240, overflow: 'hidden', padding: 22 },
  everyonePanel: { justifyContent: 'space-between' },
  everyoneWide: { flex: 2 },
  sidePanel: { flex: 1 },
  panelCopy: { zIndex: 2 },
  ...
  chipDot: { backgroundColor: '#b777ff', borderRadius: 4, height: 8, width: 8 },
  chipText: { color: '#f2eaff', fontSize: 12, fontWeight: '700' },
  privacyPanel: { justifyContent: 'center' },
  checkRow: { alignItems: 'center', flexDirection: 'row', gap: 12, marginTop: 16 },
  lineIcon: { alignItems: 'center', borderColor: 'rgba(222, 211, 255, 0.45)', borderRadius: 11, borderWidth: 1, height: 22, justifyContent: 'center', width: 22 },
  lineIconDot: { backgroundColor: '#c8b6ff', borderRadius: 4, height: 7, width: 7 },
  checkText: { color: '#e1dce9', flex: 1, fontSize: 13, lineHeight: 19 },
  moonGlow: { backgroundColor: 'rgba(124, 83, 212, 0.22)', borderRadius: 34, bottom: 20, height: 68, position: 'absolute', right: 24, width: 68 },
  hiddenPanel: { flexDirection: 'row', paddingRight: 12 },
  hiddenCopy: { flex: 1, zIndex: 2 },
  hiddenRow: { alignItems: 'center', flexDirection: 'row', gap: 10, marginTop: 12 },
  hiddenShield: { borderBottomColor: '#d7c2ff', borderBottomWidth: 9, borderLeftColor: 'transparent', borderLeftWidth: 6, borderRightColor: 'transparent', borderRightWidth: 6, height: 0, width: 14 },
  hiddenText: { color: '#eee8ff', flex: 1, fontSize: 13 },
  phoneMock: {
    alignItems: 'center',
    alignSelf: 'center',
  ...
  phoneNotch: { backgroundColor: '#020412', borderBottomLeftRadius: 10, borderBottomRightRadius: 10, height: 16, position: 'absolute', top: 0, width: 48 },
  phoneLogo: {
    alignItems: 'center',
